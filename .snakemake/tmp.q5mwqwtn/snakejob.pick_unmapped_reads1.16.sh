#!/bin/bash
# properties = {"type": "single", "rule": "pick_unmapped_reads1", "local": false, "input": ["../bam/20201117-293T-WGS_.DigenomeSeq_HEK4_Aligned_sortp.bam"], "output": ["../bam/20201117-293T-WGS_.DigenomeSeq_HEK4_Aligned_sortp.unmapped.bam"], "wildcards": {"date": "20201117", "cell": "293T", "seq": "WGS", "sample": "DigenomeSeq_HEK4"}, "params": {}, "log": [], "threads": 1, "resources": {}, "jobid": 16, "cluster": {}}
...
-m snakemake ../bam/20201117-293T-WGS_.DigenomeSeq_HEK4_Aligned_sortp.unmapped.bam --snakefile /gpfs/user/zhaohuanan/3.project/22.2020-11_1112_JSK_DigenomeSeq_WGS/snakepipes_WGS-BWAmapping/Snakefile.py \
